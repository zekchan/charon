...
func bindCreateDKGFlags(cmd *cobra.Command, config *createDKGConfig) {
	...
	cmd.Flags().StringVar(&config.Network, "network", defaultNetwork, "Ethereum network to create validators for. Options: mainnet, goerli, gnosis, chiado, sepolia, holesky.")
